...
var debug = require('debug')('PSEye');
var inherits = require('util').inherits;
var EventEmitter = require('events').EventEmitter;
var clone = require('../node_modules/hap-nodejs/lib/util/clone').clone;
var uuid = hap.uuid;
var Service = hap.Service;
var Characteristic = hap.Characteristic;
var StreamController = hap.StreamController;
var HomeKitTypes = require('../node_modules/hap-nodejs/lib/gen/HomeKitTypes');
...
PSEye.prototype.handleSnapshotRequest = function(request, callback) {
  ...
  cmd.run('sudo sh /opt/homekit/task');
  var snapshot = fs.readFileSync('/opt/homekit/snapshot.jpg');
  callback(undefined, snapshot);
}

PSEye.prototype.handleCloseConnection = function(connectionID) {
  this.streamControllers.forEach(function(controller) {
    controller.handleCloseConnection(connectionID);
  });
}

PSEye.prototype.prepareStream = function(request, callback) {
...
PSEye.prototype.handleStreamRequest = function(request) {
...
PSEye.prototype.createCameraControlService = function() {
...
PSEye.prototype._createStreamControllers = function(maxStreams, options) {
  let self = this;
...
const cameraAccessory = new hap.Accessory("PSEye", hap.uuid.generate("PSEye"));
const cameraSource = new PSEye();
cameraAccessory.configureCameraSource(cameraSource);
cameraAccessory.on('identify', function(paired, callback) {
  console.log("PSEye identify");
  callback(); // success
});

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
cameraAccessory.username = "a0:13:ef:20:36:4e" + "pseye";
cameraAccessory.pincode = "213-17-999";
cameraAccessory.category = hap.Accessory.Categories.CAMERA;
exports.accessory = cameraAccessory;
